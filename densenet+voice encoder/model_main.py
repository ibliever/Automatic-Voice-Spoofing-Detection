...
import models
from models import SpectrogramModel, MFCCModel, CQCCModel, DenseNet, Bottleneck, CQCCBotNet, SpectBotNet, MFCCBotNet, LFCCBotNet, FeatureExtractor, deit_base_patch16_224, seDenseTransNet, SEDenseNet
...
if __name__ == '__main__':
    ...
    track = args.track
    assert args.features in ['mfcc', 'spect', 'cqcc', 'mfcc_dense', 'spect_dense', 'cqcc_dense', 'lfcc', 'lfcc_dense', 'lfcc_sedense', 'mfcc_botnet', 'spect_botnet', 'lfcc_botnet', 'cqcc_botnet', 'lfcc_deit', 'cqcc_deit', 'mfcc_deit', 'spect_deit', 'lfcc_sedensetrans', 'spect_sedense', 'fuse_sedense'], 'Not supported feature'
