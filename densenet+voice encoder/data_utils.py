...
class ASVDataset(Dataset):
    ...
    def __init__(self, transform=None, 
        ...
        elif feature_name == 'cqcc' or feature_name == 'lfcc' or feature_name == 'lfcc_dense' or feature_name == 'lfcc_sedense'  or feature_name == 'cqcc_dense' or feature_name == 'cqcc_botnet' or feature_name == 'lfcc_botnet' or feature_name == 'lfcc_deit':
