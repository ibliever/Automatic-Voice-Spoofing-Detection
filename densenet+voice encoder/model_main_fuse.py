...
if __name__ == '__main__':
    ...
    track = args.track
    assert args.features in ['face_sedense', 'fuse_cqt_seres2net', 'fuse_cqt_sedense', 'mfcc', 'spect', 'cqcc', 'mfcc_dense', 'spect_dense', 'cqcc_dense', 'lfcc', 'lfcc_dense', 'lfcc_sedense', 'mfcc_botnet', 'spect_botnet', 'lfcc_botnet', 'cqcc_botnet', 'lfcc_deit', 'cqcc_deit', 'mfcc_deit', 'spect_deit', 'lfcc_sedensetrans', 'fuse_sedense', 'fuse_spect_sedense'], 'Not supported feature'
    ...
    if args.features == 'mfcc':
        ...
        print("*************fuse_spect_seDenseNetModel**********************")
                ...
                print("*************fuse_cqt_seDenseNetModel**********************")
    elif args.features == 'face_sedense':
                feature_fn = None
                model_cls = SEDenseNet
                print("*************face_seDenseNetModel**********************")
