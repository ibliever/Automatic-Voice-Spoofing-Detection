...
class Speaker():
	...
	def __init__(self, sample_rate = 16000, duration = 6, mono = True, window = 400, stride = 160, fft_length = 512, amp_norm = 0.3, verbose = False, audios_path="./data/audio/eval/", spect_path="./data/spect/eval/", flac_path ="./data/flac/eval/"):
